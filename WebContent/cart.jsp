...
<html>
	...
	<body>
		...
		<!-- 判断购物车中是否有商品 -->
		<!-- session中没有cart，cart.cartItemss不会报空指针异常 -->
							...
							<tbody>
								...
								<c:forEach items="${cart.cartItems}" var="entry">
									<tr class="active">
										...
										<td>
											<a href="javascript:void(0)" class="delete" onclick = "myDelete(${entry.key})">删除</a>
										</td>
									</tr>
								</c:forEach>
		...
		<c:if test="${empty cart.cartItems}">
			<div class="container">
				<img alt="无图言叼" src="${pageContext.request.contextPath}/images/cart-empty.png">
