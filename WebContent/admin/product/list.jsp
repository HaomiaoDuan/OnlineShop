...
<script type="text/javascript">
			...
			function delProduct(pid){
				...
				if(isDel){
					//要删除的话，就跳转servlet
					location.href = "${pageContext.request.contextPath}/admin?method=adminDelProduct&pid="+pid;
					//框架内网页跳转用location.href，全网页跳转用window.location.href
				}
			}
		</script>
</HEAD>
							...
							<c:forEach items="${productList}" var="product" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px">
										<a href="${pageContext.request.contextPath}/admin?method=adminUpdateProductUI&pid=${product.pid}">
